...
verificaron su correo dentro de la ventana de tiempo permitida. Gracias
a las Foreign Keys con ON DELETE CASCADE, esto también borra en cascada
su perfil, historial y códigos de verificación asociados.
"""
